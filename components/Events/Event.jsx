...
const Event = ({ event }) => {
  return (
    ...
    transition-all h-[440px] rounded-3xl flex flex-col 
    justify-start p-4 w-[320px] sm:w-full mx-auto sm:mx-0"
    >
      <div className="relative w-full h-[320px] mb-10">
        ...
        />
        <div
          className="absolute -bottom-[24px] left-4 bg-accent w-[110px] 
        h-[48px] text-[13px] uppercase font-medium 
        rounded-full flex items-center justify-center"
        >
          {/* this one is type of event with rounded orange part */}
          {event.type}
        </div>
      </div>
